                ...
                <div class="wrapper">
                        <div class="sidebar">
                                <div class="sidebar-wrapper">
                                    <div class="logo">
                                        <a href="#" class="simple-text logo-mini"><?php echo e(_('BD')); ?></a>
                                        <a href="#" class="simple-text logo-normal"><?php echo e(_('Black Dashboard')); ?></a>
                                    </div>
                                    <ul class="nav">
                                        <li>
                                                ...
                                                <ul class="nav pl-4">
                                                    <li >
                                                        <a href="<?php echo e(route('profile.edit')); ?>">
                                                            ...
                                                            <p><?php echo e(_('User Profile')); ?></p>
                                                        </a>
                                                    </li>
                                                    <li class="active">
                                                        <a href="<?php echo e(route('users.index')); ?>">
                                                            <i class="tim-icons icon-bullet-list-67"></i>
                                                            <p><?php echo e(_('User Management')); ?></p>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
...
</html><?php /**PATH /var/www/html/elite/resources/views/users/index.blade.php ENDPATH**/ ?>