              ...
              <li>
                ...
                @else
                  ...
                  @elseif(Auth::user()->hasRole('instructor'))
                      <a class="btn btn-colored btn-flat bg-theme-color-sky text-white font-16 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" href="/dashboard/instructor">Dashboard</a>        
                  @elseif(Auth::user()->hasRole('parent'))
                      <a class="btn btn-colored btn-flat bg-theme-color-sky text-white font-16 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" href="/dashboard/parent">Dashboard</a>   
                  @else
                      <a class="btn btn-colored btn-flat bg-theme-color-sky text-white font-16 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" href="/dashboard/student">Dashboard</a>         
                  @endif
