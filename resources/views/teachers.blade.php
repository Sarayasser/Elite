...
@section('content')
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="{{asset('images/bg/bg3.jpg')}}">
        <div class="container pt-70 pb-20">
            ...
            <div class="row"> 
                <div class="col-md-6">
                <h2 class="text-theme-color-yellow font-36">Teachers</h2>
        ...
        <div class="row mtli-row-clearfix">
         <div class="team-members">
            <div class="col-xs-12 col-sm-6 col-md-3 sm-text-center mb-sm-15">
              <div class="team-member maxwidth400">
                <div class="team-thumb">
                  <img class="img-fullwidth mt-15" src="images/team/team1.jpg" alt="">
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 sm-text-center mb-sm-15">
              <div class="team-member maxwidth400">
                <div class="team-thumb">
                  <img class="img-fullwidth mt-15" src="images/team/team2.jpg" alt="">
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 sm-text-center mb-sm-15">
              <div class="team-member maxwidth400">
                <div class="team-thumb">
                  <img class="img-fullwidth mt-15" src="images/team/team4.jpg" alt="">
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 sm-text-center">
              <div class="team-member maxwidth400">
                <div class="team-thumb">
                  <img class="img-fullwidth mt-15" src="images/team/team9.jpg" alt="">
                </div>
